...
const Trade: React.FC<any> = ({
    ...
    setSelectedToAction,
    isLoadingTokenList,
    selectedActionTokenList,
    setSelectedActionTokenList,
    handleActionChange,
}: tTrade) => {
    const {
        maxBalance,
                                                                    ...
                                                                    <div className="bg-backgound-100 text-font-200 rounded-lg p-3 my-1.5">
                                                                        ...
                                                                        {tokensSupported?.[selectedFromNetwork.chainName]?.[item.name] && (
                                                                            <div className="flex justify-center items-center gap-3 pb-3">
                                                                                <button
                                                                                    ...
                                                                                    className={`text-sm text-font-100 bg-transparent hover:bg-font-800 active:bg-font-1000 border font-medium px-3 py-1 rounded-md ${selectedFromAction === ACTION_TYPE.LENDING && '!bg-font-900'}`}
                                                                                >
                                                                                    {ACTION_TYPE.LENDING}
                                                                                </button>
                                                                                <button
                                                                                    ...
                                                                                    className={`text-sm text-font-100 bg-transparent hover:bg-font-800 active:bg-font-1000 border font-medium px-3 py-1 rounded-md ${selectedFromAction === ACTION_TYPE.BORROW && '!bg-font-900'}`}
                                                                                >
                                                                                    {ACTION_TYPE.BORROW}
                                                                                </button>
                                                                                <button
                                                                                    ...
                                                                                    className={`text-sm text-font-100 bg-transparent hover:bg-font-800 active:bg-font-1000 border font-medium px-3 py-1 rounded-md ${selectedFromAction === ACTION_TYPE.REPAY && '!bg-font-900'}`}
                                                                                >
                                                                                    {ACTION_TYPE.REPAY}
                                                                                </button>
                                                                                <button
                                                                                    ...
                                                                                    className={`text-sm text-font-100 bg-transparent hover:bg-font-800 active:bg-font-1000 border font-medium px-3 py-1 rounded-md ${selectedFromAction === ACTION_TYPE.WITHDRAW && '!bg-font-900'}`}
                                                                                >
                                                                        ...
                                                                        {isLoadingTokenList ? (
                                                                            ...
                                                                            <div className="w-full flex flex-col justify-center items-center gap-0">
                                                                                {Object.values(selectedActionTokenList).length > 0 && Object.values(selectedActionTokenList).map((item: any) => (
                                                                                        <div
                                                                            ...
                                                                            <div className="flex justify-center items-center gap-3 pb-3">
                                                                                ...
                                                                                {selectedFromProtocol === "erc20" ? (
                                                                                    <button
                                                                                        ...
                                                                                        className={`text-sm text-font-100 bg-transparent hover:bg-font-800 active:bg-font-1000 border font-medium px-3 py-1 rounded-md ${selectedToAction === ACTION_TYPE.LENDING && '!bg-font-900'}`}
                                                                                    >
                                                                                        {ACTION_TYPE.LENDING}
                                                                                    </button>
                                                                                ) : (
                                                                                    <>
                                                                                        <button
                                                                                            ...
                                                                                            className={`text-sm text-font-100 bg-transparent hover:bg-font-800 active:bg-font-1000 border font-medium px-3 py-1 rounded-md ${selectedToAction === ACTION_TYPE.REPAY && '!bg-font-900'}`}
                                                                                        >
                                                                                            {ACTION_TYPE.REPAY}
                                                                                        </button>
                                                                                        ...
                                                                                        <button
                                                                                            type="button"
                                                                                            onClick={() => handleActionChange(ACTION_TYPE.WITHDRAW, 'To')}
                                                                                            className={`text-sm text-font-100 bg-transparent hover:bg-font-800 active:bg-font-1000 border font-medium px-3 py-1 rounded-md ${selectedToAction === ACTION_TYPE.WITHDRAW && '!bg-font-900'}`}
                                                                                        >
                                                                                            {ACTION_TYPE.WITHDRAW}
                                                                                        </button>
                                                                                    </> 
