                    ...
                    <div className="w-full flex flex-col justify-center items-center gap-3">
                        ...
                        <div className="w-full flex flex-col justify-center items-center gap-3 my-1">
                            <div className="w-full relative rounded-md overflow-hidden my-2">
                                ...
                                <select
                                    className="w-full bg-font-100 font-medium outline-none shadow-outline border-2 rounded-md py-2 px-3 block appearance-none leading-normal focus:border-transparent"
                                ...
                                <div className="bg-font-100 pointer-events-none absolute right-0 top-0 bottom-0 flex items-center px-2">
