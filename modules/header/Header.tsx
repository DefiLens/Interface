...
import AvatarIcon from "../portfolio/Avatar";
...
const Header: React.FC<{ title: string }> = ({ title }) => {
    ...
    return (
        <div className="h-full w-full text-xs font-semibold text-B200 mb-6">
            <h1 className="text-4xl font-bold text-B200">{title}</h1>
        </div>
    );
};
...
//     {mobileMenuOpen && (
//         <div
//             className="fixed inset-0 bg-black opacity-50 z-[99] lg:hidden"
...
//         } fixed lg:static left-0 top-0 z-[100] bg-W100 min-h-screen max-h-screen w-64 lg:w-72 border-r border-W300 px-3 py-2 transition-transform duration-300 ease-in-out overflow-hidden`}
//     >
//         {/* <div className="h-full"> */}
//         <h1 className="flex items-center justify-center w-full font-bold text-sm md:text-xl h-[5rem]">
//             <Link href="/">
//                 {/* DefiLens<span className="text-teal-600">.</span> */}
...
//                     <div className="lg:hidden flex h-full px-4 rounded-lg border text-xs font-semibold text-B200 border-gray-300 bg-W100 transition-all duration-300 ease-in-out transform shadow-sm text-secondary items-center justify-center font-condensed">
//                         Balance: 57,078,126.78 USDC
//                     </div>
//                     <button className="lg:hidden flex h-full px-4 rounded-lg border text-xs font-semibold text-B200 border-gray-300 bg-W100 hover:bg-white transitionz-all duration-300 ease-in-out transform shadow-sm items-center justify-center gap-1 font-condensed">
...
// </header>
{
    /* <div id="profile" className="space-y-3 border border-green-700"> */
}
{
    /* <div id="profile" className="space-y-3">
                        ...
                        <div className="flex justify-center items-center">
                            <AvatarIcon address={address ?? ""} size={120} />
                        </div>
                        <div>
                        ...
                        <div className="flex gap-2">
                            <button className="w-full text-sm font-medium text-gray-700 py-2 px-2 hover:bg-teal-500 hover:text-white hover:text-base rounded-md transition duration-150 ease-in-out border flex items-center gap-2">
                                <MdOutlineFileDownload className="w-6 h-6 fill-current inline-block" />
                                <span className="">Deposit USDC</span>
                            </button>
                        </div>
                    </div> */
}
