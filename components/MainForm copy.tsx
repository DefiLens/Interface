...
//     const polygonContractDetails: any = allNetworkDetails['109']
...
//         if (currentFuncIndex) {
//             let _params: any = []
//             const toContractData = allNetworkDetails[toChainId]
...
//             const fromContractData = allNetworkDetails[fromChainId]
//             const toContractData = allNetworkDetails[toChainId]
...
//             "http://localhost:3000/aavev3/aavev3/supply",
//             {
//               params: {
//                 methodName: funcArray[funcIndex].name,
//                 tokenIn: fromContractData.USDC,
//                 tokenInAtOetherNetwork: fromContractData.USDC,
//                 amountIn: amountIn,
//                 scw: smartAccount.address,
//                 eoa: address,
//                 toNetwork: fromChainId,
//                 fromNetwork: toChainId,
...
//           console.log("getSupply-Resp: ", response);
//         } catch (error) {
//           console.log("getSupply---error", error);
//         }
//     }

//     const test = async () => {
//         const toNetwork = '106'; // Replace with the desired toNetwork value

//         axios.get<ApiResponse>(`http://localhost:3000/aavev3/getNetworkAndContractData/${toNetwork}`)
//         .then((response) => {
...
//                                 {
//                                     allNetworkDetails[toChainId].contractAddresses.length > 0 &&
//                                     allNetworkDetails[toChainId].contractAddresses.map((
...
//                                 </h3>
//                                 <h4>{bg(amountIn).dividedBy(bg(10).pow(tokenInDecimals)).toString()} USDC will bridge from {allNetworkDetails[fromChainId].network} to {allNetworkDetails[toChainId].network} and call {funcArray[currentFuncIndex].name} method and deposit into aave.</h4>
//                             </>
//                         )}
