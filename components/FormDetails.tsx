...
export default function FormDetails({ balance, aToken, index }) {
    ...
    <>
      ...
      >
        ...
        >
          ...
          >
            <option value="">-</option>
            <option value="recipe1.1">
              recipe1 (aave withdraw - swap - compound deposit)
            </option>
            <option value="recipe1.2">
              recipe2 (aave withdraw - swap - aave deposit)
            </option>
            <option value="recipe1.3">recipe3 (aave withdraw - swap)</option>
            <option value="recipe1.4">
              recipe4 (aave borrow - aave deposit)
            </option>
            <option value="recipe1.5">
              recipe5 (aave borrow - compound deposit)
            </option>
            <option value="recipe1.6">
              recipe6 (aave borrow - swap - compound deposit)
            </option>
          </select>
          {receipeName && (
            <>
            ...
            /> */}
              ...
              {receipeName != "recipe1.4" && receipeName != "recipe1.5" && (
                <>
                  <div>
                    {/* <input
                  style={{
                  ...
                  onChange={(e: any) => handleTokeOut(e.target.value)}
                /> */}
                    <label>Choose tokenOut: </label>
                    <select
                      name="recipe"
                      id="recipe"
